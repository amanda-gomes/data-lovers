...
document.getElementById("back1").addEventListener("click", clean);
document.getElementById("back2").addEventListener("click", clean);
document.getElementById("back3").addEventListener("click", clean);
document.getElementById("back4").addEventListener("click", clean);
